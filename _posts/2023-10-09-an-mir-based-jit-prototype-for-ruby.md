...
[![MIR-based CRuby JIT data flow](/assets/images/an-mir-based-jit-prototype-for-ruby/mirjit.png?itok=-TCW7GiO) ](/assets/images/an-mir-based-jit-prototype-for-ruby/mirjit.png) Figure 1: MIR-based JIT data flow.
...
[![Dispatch.](/assets/images/an-mir-based-jit-prototype-for-ruby/dispatch_0.png?itok=c-QrCMR3) ](/assets/images/an-mir-based-jit-prototype-for-ruby/dispatch_0.png) Figure 2: Dispatch.
...
[![Dispatch redirection diagram.](/assets/images/an-mir-based-jit-prototype-for-ruby/dispatch2.png?itok=w_XluLsm) ](/assets/images/an-mir-based-jit-prototype-for-ruby/dispatch2.png) Figure 3: Dispatch redirection.
...
[![x86-64 micro-benchmarks.](/assets/images/an-mir-based-jit-prototype-for-ruby/mir-wall.png?itok=JCo0D8wJ) ](/assets/images/an-mir-based-jit-prototype-for-ruby/mir-wall.png) Figure 4: x86-64 micro-benchmarks.
...
[![ARM64 micro-benchmarks](/assets/images/an-mir-based-jit-prototype-for-ruby/mir-wall-arm64.png?itok=cZ23jdcM) ](/assets/images/an-mir-based-jit-prototype-for-ruby/mir-wall-arm64.png) Figure 6: ARM64 micro-benchmarks.
...
[![OptCarrot](/assets/images/an-mir-based-jit-prototype-for-ruby/carrot_0.png?itok=AHxOGbBC) ](/assets/images/an-mir-based-jit-prototype-for-ruby/carrot_0.png) Figure 7: OptCarrot.
